...
class BaseOptions(ModelOption):
    def initialize(self, parser):
        ...
        parser.add_argument('--img_save_feq', type=int, default=25, help='fequence that save gen results')

        parser.add_argument('--gpu', type=str, default='0', help='number of using gpus')
        parser.add_argument('--ver', type=float, default=1.9, help='models version')
...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--every_val_epoch', type=int, default=40, help='# of iter to run test while training')
...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--data_dir', type=str, default='/home/sd01/EADT/dataset/test_single/CUFSF', help='saves results here.')
        parser.add_argument('--checkpoint_dir', type=str, default='/home/sd01/EADT/checkpoint/linshi.ckpt', help='saves checkpoint here.')
