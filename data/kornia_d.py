    ...
    def apply_tranform(self, tensors):
        ...
        if self.forTrain:
            ...
            if self.affine_type == "normal":
                y_trans_arr.append(kornia.geometry.Resize((loadSize, loadSize)))
            ...
            y_trans_arr.append(kornia.Resize((self.opt.input_size, self.opt.input_size)))
